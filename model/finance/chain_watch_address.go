...
type ChainWatchAddress struct {
	...
	ContractAddress string `gorm:"column:contract_address;type:varchar(128)" json:"contractAddress" form:"contractAddress"` // TRC20/ERC20 合约；空则用对应链配置默认
	WatchTRX        bool   `gorm:"column:watch_trx;default:0" json:"watchTrx" form:"watchTrx"`                              // TRON: 监听 TRX；ETHEREUM: 监听原生 ETH
