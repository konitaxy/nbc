...
import (
	...
	systemRes "gitlab.com/ucard/model/system/response"
...
func (b *BaseApi) Register(c *gin.Context) {
	...
	inviteCode := utils.GenerateRandomNumber(6)
	user := &system.SysUser{Username: r.Username, NickName: r.NickName, Password: r.Password, HeaderImg: r.HeaderImg, AuthorityId: r.AuthorityId, Authorities: authorities, InviteCode: inviteCode}
