...
func (userService *UserService) GetUserInfoByInviteCode(inviteCode string) (user system.SysUser, err error) {
	var reqUser system.SysUser
	err = global.GVA_DB.First(&reqUser, "invite_code = ?", inviteCode).Error
