      ...
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="userForm" :rules="rules" :model="userInfo" label-width="80px">
          ...
          <el-form-item label="头像" style="max-width: 200px;">
            <el-select v-model="userInfo.headerImg">
                    <template #label>
                      <img style="scale: 0.8;max-width: 40px;" class="select-img object-fit-scale w-100 h-100" :src="userInfo.headerImg"></img>
                    </template>
                    <el-option v-for="item in headimgs" :value="item">
                        <img class="object-fit-scale w-100 h-100" style="max-width: 50px;"  :src="item"></img>
                    </el-option>
                  </el-select>
          </el-form-item>
        </el-form>
