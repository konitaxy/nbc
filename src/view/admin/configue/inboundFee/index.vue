        ...
        <div>
          <el-form :inline="true" class="mb-4" label-position="top">
            ...
            <el-form-item label="Available">
              <el-select v-model="search.available" clearable placeholder="All" style="width: 150px;">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="User ID">
                  <el-input v-model="search.userId" placeholder="Please enter user id"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="24">
                ...
                <el-button @click="resetSearch">Reset</el-button>                </el-form-item>
      ...
      <el-tab-pane v-for="item of feeTypes" :label="item.label" :name="item.value">
        <div class="row bg-body-secondary p-2 mx-2">
            ...
            <div class="col-4 offset-2"> 
              ...
              <div>Available: {{ currTabCfg.available === true ? 'true' : 'false' }}</div>
            </div>
        </div>
        <div class="row p-2 mt-4 mx-2" style="border: 1px solid #ddd; border-top: none;">
...
import { addFeeGlobalCfg,addFeeUserCfg,setUserCfgGlobal,listFeeUserCfg,listFeeGlobalCfg,listLogs } from '@/api/finance';
import { formatDate } from '@/utils/format';
import { ElMessage } from 'element-plus'
const feeTypes = [
  { label: "Wallet Inbound", value: "WALLET_INBOUND" },
]
const activeTab = ref('userFeeConfig');
const search =reactive({
  cardBin: '',
  feeType:'WALLET_INBOUND',
  cfgType: 2,
  cardBin:'All',
  cardType:'',
  cardBinId:'',
